    ...
    <div id="wrap">
      <div id="top">
        ...
        <header class="head">
          ...
          <div class="main-bar">
            <h3>
               <i class="fa fa-cutlery"></i> Alterar/ Consultar Receita </h3>
          </div><!-- /.main-bar -->
        </header>
          ...
          <div class="inner">
            <div class="col-lg-12">
              ...
              <div class="control-group">
                ...
                <button style="margin-left:5px; "type="submit" class="btn btn-primary inline">Buscar</button>		
				</div>
			</div>
			<br><br>
			<h4>Selecione uma receita para editar</h4>
			...
			<br>
              <br><br><br>
				<label for="nome" class="control-label col-lg-1">Título</label>
				<div class="col-lg-8">
